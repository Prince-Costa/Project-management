                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="work_id" id="work_id" class="form-select border border-primary">
                                        ...
                                        @foreach ($projects as $project)
                                            <option value="{{ $project->id }}" {{ $invoice->work_id == $project->id ? 'selected' : '' }}>{{ $project->title }}</option>          
                                        @endforeach
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" name="description" id="description" class="form-control border border-primary" placeholder="Enter description">{{ $invoice->description }}</textarea>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
