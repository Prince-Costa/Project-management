...
@section('content')
    ...
    <div class="row mx-0 mt-3">
        <div class="col-lg-5">
            ...
            <form action="{{ route('tags.store') }}" method="POST" class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control border border-primary" required placeholder="Tag Name" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="background_color" id="background_color" class="form-control border border-primary" required placeholder="Enter Tag Banckground color" value="{{ old('background_color') }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="text_color" id="text_color" class="form-control border border-primary" required placeholder="Enter Tag Text color" value="{{ old('text_color') }}">
                            @error('text_color')
                                <div class="text-danger">{{ $message }}</div>   
                            @enderror
                        </div>
        ...
        <div class="col-lg-7 mt-lg-0 mt-5">
            ...
            <div class="h-100 p-2">
                <h3 class="mb-4 text-center">Tags</h3>
